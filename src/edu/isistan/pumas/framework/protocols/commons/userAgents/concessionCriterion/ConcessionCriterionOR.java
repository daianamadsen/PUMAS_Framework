...
public class ConcessionCriterionOR<T extends SURItem> extends ConcessionCriterionComposed<T> {
	...
	public String toString() {
		return "ConcessionCriterionOR [criterias=" + criterias + "]";
	}
